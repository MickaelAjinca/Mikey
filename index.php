...
<body>
    ...
    <h1 class="text-center mt-3">Merci d'avoir voté</h1>
...
<footer>
    ...
    <div class="d-flex flex-row justify-content-center align-items-center">
        ...
        <P class="text-center">Je suis Mickaël Ajinça, en formuleje supporte Lewis Hamilton qui est le meilleur pilote de l'histoire de la F1.<br> Il est le plus grand champion de la catégorie avec la meilleure équipe de ses dernières années Mercedes F1 Team.</P>
    </div>
</footer>
